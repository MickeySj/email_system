                    ...
                    <table border="0" cellspacing="" cellpadding="" class="list animated wobble">
                        ...
                        <tr class="order-info">
                            <td colspan="8">
                                ...
                                <i class="order-num">${order.id}
                                </i>
                                <span style="margin-left: 40px;">下单时间&nbsp;:&nbsp;</span>
                                <i class="order-num">
                                        <%--                                    <fmt:formatDate value="${order.systime}" pattern="yyyy-MM-dd HH:mm:ss"/></i>--%>
                                    <span>${order.systime}</span>
                                </i>
                            </td>
                        </tr>
                        <tr class="order" style="margin-bottom: 10px;">
                            ...
                            <c:forEach items="${order.itemList}" var="item" end="0">
                                <td class="li1" style="text-align: left;" colspan="4">
                                    <a href="/goods/detail?id=${item.goodId}"><img
                                            src="../index/${item.good.cover}"></a>
                                    <div class="m-good-descript">
                                        <a href="/goods/detail?id=${item.goodId}"><p
                                ...
                                <div>
                                    <p>
                                        <c:if test="${order.status==1}">
                                            <a href="/order/orderPay?id=${order.id}"><span
