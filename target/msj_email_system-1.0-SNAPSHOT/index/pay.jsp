...
<div id="main">
        ...
        <div class="list-cont">
            ...
            <c:forEach items="${order.itemList}" var="item">
                <ul>
                    <li class="li1">
                        <dl>
                            <a href="../index/detail?id=${item.good.id}">
                                <dt><img src="../index/${item.good.cover}"></dt>
    ...
    <div id="collect">
        ...
        <div class="collect-cont new-address" style="padding: 0px 0px;">
            <%-- 表单提交 orderId payType userName phone address --%>
            <form action="/order/orderPay" method="post" id="form">
